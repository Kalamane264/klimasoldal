...
export default function Home() {
  ...
  const infoContent = {
    hu: {
      ...
      stockDesc: <>A <Link href="/klimak" className="text-primary hover:underline font-medium"><b>Készülékek</b></Link> menüpontban az állandóan elérhető kínálatunkat láthatja. Ezen felül rendszeresen kínálunk <strong>egyedi akciós készülékeket</strong> is.</>,
    ...
    en: {
      ...
      stockDesc: <>In the <Link href="/klimak" className="text-primary hover:underline font-medium"><b>Products</b></Link> section, you can see our permanently available range. In addition, we regularly offer <strong>unique discounted devices</strong>.</>,
