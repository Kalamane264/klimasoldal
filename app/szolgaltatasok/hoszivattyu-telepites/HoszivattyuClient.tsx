...
export default function HoszivattyuClient() {
  ...
  const t =
    language === "hu"
      ? {
          ...
          area: "Hőszivattyú-telepítést országszerte, de Pécs környékén kiemelten (gyorsabban, olcsóbban) vállalunk.",
      ...
      : {
          ...
          area: "We undertake heat pump installations nationwide, with a primary focus on the Pécs area (where we offer faster and more cost-effective service).",
