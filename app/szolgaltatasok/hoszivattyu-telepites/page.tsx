...
export default function HeatPumpInstallation() {
  ...
  const t = language === 'hu' ? {
    ...
    description: {
      ...
      bullets: ["Teljes körű tervezés és méretezés", "Szakszerű telepítés és beüzemelés", "H-tarifa ügyintézés támogatása", "Rendszeres karbantartás"]
    },
    benefits: [
      { title: "Rezsicsökkentés", desc: "Akár 70% megtakarítás", icon: <TrendingDown className="w-6 h-6" /> },
      { title: "Értéknövelés", desc: "Növeli az ingatlan értékét", icon: <ShieldCheck className="w-6 h-6" /> },
      { title: "Környezetbarát", desc: "Alacsony károsanyag-kibocsátás", icon: <CheckCircle2 className="w-6 h-6" /> },
      { title: "Modern technológia", desc: "Jövőbiztos megoldás", icon: <Settings className="w-6 h-6" /> }
    ],
    forWhom: ["Új építésű házakhoz", "Korszerűsítés előtt állóknak", "Gázról leválni kívánóknak", "Napelemes rendszerek mellé"],
    faq: [
      { q: "Mennyi idő alatt térül meg?", a: "A jelenlegi energiaárak mellett 5-8 év az átlagos megtérülés." },
      { q: "Zajos a kültéri egység?", a: "A modern hőszivattyúk halkabbak, mint egy átlagos beszélgetés." },
      { q: "Működik fagyban is?", a: "Igen, a korszerű rendszerek -25°C-ig üzembiztosak." }
    ],
    ...
    description: {
      ...
      bullets: ["Complete system planning", "Professional installation", "Administrative support for subsidies", "Regular maintenance"]
    },
    benefits: [
      { title: "Utility Savings", desc: "Up to 70% reduction", icon: <TrendingDown className="w-6 h-6" /> },
      { title: "Property Value", desc: "Increases home equity", icon: <ShieldCheck className="w-6 h-6" /> },
      { title: "Eco-friendly", desc: "Low carbon footprint", icon: <CheckCircle2 className="w-6 h-6" /> },
      { title: "Modern Tech", desc: "Future-proof solution", icon: <Settings className="w-6 h-6" /> }
    ],
    forWhom: ["New construction", "Home upgrades", "Gas replacement", "Solar PV owners"],
    faq: [
      { q: "What is the ROI period?", a: "With current energy prices, usually 5-8 years." },
      { q: "Is the outdoor unit noisy?", a: "Modern units are quieter than an average conversation." },
      { q: "Does it work in freezing cold?", a: "Yes, modern systems operate reliably down to -25°C." }
    ],
