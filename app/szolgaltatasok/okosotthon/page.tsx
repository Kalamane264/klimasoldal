    ...
    language === "hu"
      ? {
          ...
          description: {
            ...
            bullets: [
              "Távvezérelhető klímarendszerek",
              "Energiafogyasztás figyelése",
              "Intelligens jelenetek beállítása",
              "Egyszerű applikációs kezelés",
            ],
          },
          benefits: [
            {
              title: "Maximális kényelem",
              desc: "Minden automatizált",
              icon: <Smartphone className="w-6 h-6" />,
            },
            {
              title: "Energiahatékonyság",
              desc: "Optimalizált fogyasztás",
              icon: <TrendingDown className="w-6 h-6" />,
            },
            {
              title: "Könnyű kezelés",
              desc: "Nem csak technikusoknak",
              icon: <LayoutDashboard className="w-6 h-6" />,
            },
            {
              title: "Bárhonnan elérhető",
              desc: "Okostelefonos vezérlés",
              icon: <Zap className="w-6 h-6" />,
            },
          ],
          forWhom: [
            "Kényelemre vágyóknak",
            "Modernizálóknak",
            "Sokat utazóknak",
            "Tudatos energiahasználóknak",
          ],
          faq: [
            {
              q: "Milyen eszközök kellenek?",
              a: "Egy stabil Wi-Fi hálózat és kompatibilis klíma vagy kiegészítők.",
            },
            {
              q: "Bonyolult a kezelése?",
              a: "Nem, a felületek egyszerűek és magyar nyelven is elérhetők.",
            },
            {
              q: "Utólag is beépíthető?",
              a: "Igen, a legtöbb meglévő rendszer okosítható utólagos modulokkal.",
            },
          ],
      ...
      : {
          ...
          benefits: [
            {
              ...
              desc: "Everything automated",
              icon: <Smartphone className="w-6 h-6" />,
            },
            {
              title: "Energy Efficiency",
              desc: "Optimized consumption",
              icon: <TrendingDown className="w-6 h-6" />,
            },
            {
              title: "Ease of Use",
              desc: "Not just for techies",
              icon: <LayoutDashboard className="w-6 h-6" />,
            },
            {
              title: "Remote Access",
              desc: "Smartphone control",
              icon: <Zap className="w-6 h-6" />,
            },
          ],
          forWhom: [
          ...
          faq: [
            {
              q: "What devices are needed?",
              a: "A stable Wi-Fi network and compatible AC or modules.",
            },
            {
              q: "Is it hard to use?",
              a: "No, the interfaces are simple and user-friendly.",
            },
            {
              q: "Can it be retrofitted?",
              a: "Yes, most existing systems can be upgraded with smart modules.",
            },
          ],
