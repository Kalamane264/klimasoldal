    ...
    language === "hu"
      ? {
          ...
          description: {
            ...
            bullets: [
              "Régi hálózatok felújítása",
              "Új hálózatok kiépítése",
          ...
          benefits: [
            {
              ...
              desc: "Életvédelmi rendszerek",
              icon: <ShieldAlert className="w-6 h-6" />,
            },
            {
              title: "Szabványos kivitelezés",
              desc: "Hivatalos előírások szerint",
              icon: <CheckCircle2 className="w-6 h-6" />,
            },
            {
              title: "Garanciális munka",
              desc: "Hosszú távú megbízhatóság",
              icon: <ShieldCheck className="w-6 h-6" />,
            },
            {
              title: "Gyors hibajavítás",
              desc: "Sürgős esetekben is",
              icon: <Zap className="w-6 h-6" />,
            },
          ],
          forWhom: [
            "Régi házak tulajdonosainak",
            "Panel felújítás előtt állóknak",
            "Biztonságra vágyóknak",
            "Új konyhagépek beépítésekor",
          ],
          faq: [
            {
              q: "Milyen gyakran kell felújítani?",
              a: "Az alumínium vezetékeket 30-40 évente kötelező cserélni.",
            },
            {
              q: "Vállalnak kisebb munkákat?",
              a: "Igen, a konnektor cserétől a teljes felújításig mindenben segítünk.",
            },
            {
              q: "Mindenre van garancia?",
              a: "Természetesen, minden elvégzett munkánkra írásos garanciát vállalunk.",
            },
          ],
          ...
          benefits: [
            {
              ...
              desc: "Protection systems",
              icon: <ShieldAlert className="w-6 h-6" />,
            },
            {
              title: "Compliance",
              desc: "According to official standards",
              icon: <CheckCircle2 className="w-6 h-6" />,
            },
            {
              title: "Warranty",
          ...
          faq: [
            {
              ...
              a: "Aluminum wiring should be replaced every 30-40 years.",
            },
            {
              q: "Do you take small jobs?",
              a: "Yes, from outlet replacement to full renovation.",
            },
            {
              q: "Is there a warranty?",
              a: "Certainly, we provide a written warranty for all our work.",
            },
          ],
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              <div className="mb-16">
                ...
                <div className="relative w-full aspect-[16/9] rounded-3xl overflow-hidden mb-8 shadow-lg">
                  <Image 
                    src="/villanyszereles.jpg" 
                    alt={t.h1}
                    fill
              ...
              <div className="bg-primary p-12 rounded-3xl text-center text-white shadow-xl shadow-primary/20">
                ...
                <Link href="/kapcsolat">
                  <Button
                    size="lg"
                    variant="secondary"
                    className="bg-white text-primary hover:bg-slate-100 rounded-full px-12 py-8 text-xl font-bold"
                  >
                    {language === "hu" ? "Kapcsolatfelvétel" : "Contact Us"}
                  </Button>
                </Link>
