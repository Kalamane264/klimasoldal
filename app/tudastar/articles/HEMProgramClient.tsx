...
export default function HEMProgramClient() {
  ...
  const content = {
    hu: {
      ...
      intro: "A HEM program egy olyan magyarországi kezdeményezés, amely az energiahatékonysági beruházásokat ösztönzi. Laikus szemmel nézve ez egyfajta „visszatérítés” vagy kedvezmény, amit a korszerűsítés után kaphat.",
      sections: [
        {
          title: "Mi az a HEM?",
    ...
    en: {
      ...
      intro: "The HEM program is a Hungarian initiative that encourages energy efficiency investments. From a layman's perspective, it's a type of 'refund' or discount you can receive after modernization.",
      sections: [
        {
          title: "What is HEM?",
          icon: <Info className="w-5 h-5 text-primary" />,
  ...
  return (
    <div className="space-y-12">
      <div className="max-w-2xl">
        <h2 className="text-3xl font-heading font-bold text-slate-900 mb-6">{active.title}</h2>
      ...
      <div className="bg-primary/5 rounded-2xl p-8 border border-primary/10">
        <h3 className="text-xl font-bold text-slate-900 mb-6">
          {language === "hu" ? "A folyamat lépései" : "Steps of the process"}
        </h3>
      ...
      <div className="text-center p-8 border-2 border-dashed border-slate-200 rounded-2xl">
        ...
        <Link href="/kapcsolat">
          <Badge className="px-6 py-2 text-sm cursor-pointer hover:bg-primary/90 transition-colors">
            {language === "hu" ? "Érdeklődöm a részletekről" : "Inquire about details"}
