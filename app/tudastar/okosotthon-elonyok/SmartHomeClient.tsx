                            ...
                            <div className="flex items-start gap-4">
                              ...
                              <div>
                                <h4 className="font-semibold text-slate-900 mb-2">
                                  {
                                    t.smartHome.benefits.items[
                                      benefit.key as keyof typeof t.smartHome.benefits.items
                                    ].title
                                  }
                                </h4>
            ...
            <div className="mt-16 rounded-2xl bg-primary/5 border border-primary/15 px-8 py-10 flex flex-col sm:flex-row items-center gap-6">
              ...
              <div className="flex-1 text-center sm:text-left">
                <p className="font-semibold text-lg text-foreground">
                  {language === "hu"
                    ? "Okosotthon megoldásokat keres?"
                    : "Looking for smart home solutions?"}
                </p>
                <p className="text-muted-foreground text-sm mt-1">
                  {language === "hu"
                    ? "Szakértőink személyre szabott tanácsot adnak az Ön otthonához."
                    : "Our experts provide personalised advice for your home."}
                </p>
              </div>
